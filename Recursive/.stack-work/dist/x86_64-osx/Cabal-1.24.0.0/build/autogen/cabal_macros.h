...
/* package Resursive-0.1.0.0 */
#define VERSION_Resursive "0.1.0.0"
#define MIN_VERSION_Resursive(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "Resursive-0.1.0.0"

#define CURRENT_PACKAGE_KEY "Resursive-0.1.0.0"
